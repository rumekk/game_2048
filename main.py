...
class Tile:
    ...
    def get_color(self):
        color_index = int(math.log(self.value, 2)) - 1
    ...
    def draw(self, window):
        ...
        window.blit(text, (self.x + RECT_WIDTH//2 - text.get_width() //
                    2, self.y + RECT_HEIGHT//2 - text.get_height()//2))
